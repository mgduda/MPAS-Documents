...
\begin{tabular}{|p{.3\textwidth-2\tabcolsep} |p{.7\textwidth-2\tabcolsep} |} \hline
Units & \textit{unitless} \\ \hline
Description & \textit{Weighting coefficents used for reconstructing cell-based foelds at edges} \\ \hline
...
\phantomsection
\addcontentsline{toc}{section}{Fields H--O}
...
\phantomsection
\addcontentsline{toc}{section}{Fields P--R}
...
\phantomsection
\addcontentsline{toc}{section}{Fields S--W}
...
\vspace{10mm}
\noindent\begin{minipage}{\textwidth}
\hypertarget{sfc_albedo_seaice}
\noindent\textbf{\large{sfc\_albedo\_seaice}} (real) (nCells, Time) \\ 
\begin{tabular}{|p{.3\textwidth-2\tabcolsep} |p{.7\textwidth-2\tabcolsep} |} \hline
Units & \textit{unitless} \\ \hline
Description & \textit{surface albedo over seaice} \\ \hline
Accessed in code & as \bsq{sfc\_albedo\_seaice} from the \bsq{diag\_physics} pool \\ \hline
\end{tabular} 
\end{minipage}
...
\phantomsection
\addcontentsline{toc}{section}{Fields X--Z}
