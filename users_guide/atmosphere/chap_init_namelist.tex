...
\begin{tabular}{|p{.3\textwidth-2\tabcolsep} |p{.7\textwidth-2\tabcolsep} |} \hline
Units & \textit{-} \\ \hline
Description & \textit{Time to begin processing first-guess data (cases 7, 8, and 9 only)} \\ \hline
...
\begin{tabular}{|p{.3\textwidth-2\tabcolsep} |p{.7\textwidth-2\tabcolsep} |} \hline
Units & \textit{-} \\ \hline
Description & \textit{Time to end processing first-guess data (cases 8 and 9 only)} \\ \hline
Possible Values & `YYYY-MM-DD\_hh:mm:ss' \textit{(default: 2010-10-23\_00:00:00)} \\ \hline
\end{tabular} 
\end{minipage}
...
\vspace{10mm}
\noindent\begin{minipage}{\textwidth}
\hypertarget{inl:config_interface_projection}
\noindent\textbf{\large{config\_interface\_projection}} (character) \\ 
\begin{tabular}{|p{.3\textwidth-2\tabcolsep} |p{.7\textwidth-2\tabcolsep} |} \hline
Units & \textit{-} \\ \hline
Description & \textit{projecting layer values to the interface, linear vertical interpolation or integral} \\ \hline
Possible Values & 'linear\_interpolation' or 'layer\_integral' (layer average value) \textit{(default: linear\_interpolation)} \\ \hline
\end{tabular} 
\end{minipage}
...
\begin{tabular}{|p{.3\textwidth-2\tabcolsep} |p{.7\textwidth-2\tabcolsep} |} \hline
Units & \textit{-} \\ \hline
Description & \textit{The number of atmospheric levels (including surface and sea-level) in the first-guess dataset (cases 7 and 9 only)} \\ \hline
...
\vspace{10mm}
\noindent\begin{minipage}{\textwidth}
\hypertarget{inl:config_gocartlevels}
\noindent\textbf{\large{config\_gocartlevels}} (integer) \\ 
\begin{tabular}{|p{.3\textwidth-2\tabcolsep} |p{.7\textwidth-2\tabcolsep} |} \hline
Units & \textit{-} \\ \hline
Description & \textit{The number of vertical gocart levels in the climatological gocart data set} \\ \hline
...
Possible Values & Any valid path \textit{(default: /glade/work/wrfhelp/WPS\_GEOG/)} \\ \hline
\end{tabular} 
\end{minipage}
...
\begin{tabular}{|p{.3\textwidth-2\tabcolsep} |p{.7\textwidth-2\tabcolsep} |} \hline
Units & \textit{-} \\ \hline
Description & \textit{Filename prefix of ungrib intermediate file to use for initial conditions (cases 7 and 9 only)} \\ \hline
...
\begin{tabular}{|p{.3\textwidth-2\tabcolsep} |p{.7\textwidth-2\tabcolsep} |} \hline
Units & \textit{-} \\ \hline
Description & \textit{Interval between intermediate files (cases 8 and 9 only)} \\ \hline
...
Possible Values & `USGS', `MODIFIED\_IGBP\_MODIS\_NOAH', or `MODIFIED\_IGBP\_MODIS\_NOAH\_15s' \textit{(default: MODIFIED\_IGBP\_MODIS\_NOAH)} \\ \hline
\end{tabular} 
\end{minipage}

\vspace{10mm}
\noindent\begin{minipage}{\textwidth}
\hypertarget{inl:config_soilcat_data}
\noindent\textbf{\large{config\_soilcat\_data}} (character) \\ 
\begin{tabular}{|p{.3\textwidth-2\tabcolsep} |p{.7\textwidth-2\tabcolsep} |} \hline
Units & \textit{-} \\ \hline
Description & \textit{The soil category classification to use} \\ \hline
Possible Values & `STATSGO' or `BNU' \textit{(default: STATSGO)} \\ \hline
\end{tabular} 
\end{minipage}
...
Possible Values & `GTOPO30' or `GMTED2010' \textit{(default: GMTED2010)} \\ \hline
\end{tabular} 
\end{minipage}

\vspace{10mm}
\noindent\begin{minipage}{\textwidth}
\hypertarget{inl:config_vegfrac_data}
\noindent\textbf{\large{config\_vegfrac\_data}} (character) \\ 
\begin{tabular}{|p{.3\textwidth-2\tabcolsep} |p{.7\textwidth-2\tabcolsep} |} \hline
Units & \textit{-} \\ \hline
Description & \textit{The climatological monthly vegetation fraction dataset to use (case 7 only)} \\ \hline
Possible Values & `MODIS' or `NCEP' \textit{(default: MODIS)} \\ \hline
\end{tabular} 
\end{minipage}

\vspace{10mm}
\noindent\begin{minipage}{\textwidth}
\hypertarget{inl:config_albedo_data}
\noindent\textbf{\large{config\_albedo\_data}} (character) \\ 
\begin{tabular}{|p{.3\textwidth-2\tabcolsep} |p{.7\textwidth-2\tabcolsep} |} \hline
Units & \textit{-} \\ \hline
Description & \textit{The climatological monthly albedo dataset to use (case 7 only)} \\ \hline
Possible Values & `MODIS' or `NCEP' \textit{(default: MODIS)} \\ \hline
\end{tabular} 
\end{minipage}
...
\vspace{10mm}
\noindent\begin{minipage}{\textwidth}
\hypertarget{inl:config_maxsnowalbedo_data}
\noindent\textbf{\large{config\_maxsnowalbedo\_data}} (character) \\ 
\begin{tabular}{|p{.3\textwidth-2\tabcolsep} |p{.7\textwidth-2\tabcolsep} |} \hline
Units & \textit{-} \\ \hline
Description & \textit{The maximum snow albedo dataset to use (case 7 only)} \\ \hline
Possible Values & `MODIS' or `NCEP' \textit{(default: MODIS)} \\ \hline
\end{tabular} 
\end{minipage}
...
\vspace{10mm}
\noindent\begin{minipage}{\textwidth}
\hypertarget{inl:config_supersample_factor}
\noindent\textbf{\large{config\_supersample\_factor}} (integer) \\ 
\begin{tabular}{|p{.3\textwidth-2\tabcolsep} |p{.7\textwidth-2\tabcolsep} |} \hline
Units & \textit{-} \\ \hline
Description & \textit{The supersampling factor to be used for MODIS maximum snow albedo and monthly albedo datasets (case 7 only)} \\ \hline
...
\vspace{10mm}
\noindent\begin{minipage}{\textwidth}
\hypertarget{inl:config_lu_supersample_factor}
\noindent\textbf{\large{config\_lu\_supersample\_factor}} (integer) \\ 
\begin{tabular}{|p{.3\textwidth-2\tabcolsep} |p{.7\textwidth-2\tabcolsep} |} \hline
Units & \textit{-} \\ \hline
Description & \textit{The supersampling factor to be used for 30s or 15s MODIS land use, or for 30s USGS land use, as selected by `config\_landuse\_data' (case 7 only)} \\ \hline
Possible Values & Positive integer values \textit{(default: 1)} \\ \hline
\end{tabular} 
\end{minipage}

\vspace{10mm}
\noindent\begin{minipage}{\textwidth}
\hypertarget{inl:config_30s_supersample_factor}
\noindent\textbf{\large{config\_30s\_supersample\_factor}} (integer) \\ 
\begin{tabular}{|p{.3\textwidth-2\tabcolsep} |p{.7\textwidth-2\tabcolsep} |} \hline
Units & \textit{-} \\ \hline
Description & \textit{The supersampling factor to be used for 30s terrain, soil category, and MODIS FPAR monthly vegetation fraction (case 7 only)} \\ \hline
Possible Values & Positive integer values \textit{(default: 1)} \\ \hline
\end{tabular} 
\end{minipage}
...
\vspace{10mm}
\noindent\begin{minipage}{\textwidth}
\hypertarget{inl:config_noahmp_static}
\noindent\textbf{\large{config\_noahmp\_static}} (logical) \\ 
\begin{tabular}{|p{.3\textwidth-2\tabcolsep} |p{.7\textwidth-2\tabcolsep} |} \hline
Units & \textit{-} \\ \hline
Description & \textit{Whether to process, read, and write static fields only required by Noah-MP (hidden by default)} \\ \hline
...
\vspace{10mm}
\noindent\begin{minipage}{\textwidth}
\hypertarget{inl:config_hybrid_coordinate}
\noindent\textbf{\large{config\_hybrid\_coordinate}} (logical) \\ 
\begin{tabular}{|p{.3\textwidth-2\tabcolsep} |p{.7\textwidth-2\tabcolsep} |} \hline
Units & \textit{-} \\ \hline
Description & \textit{Whether to employ a hybrid vertical coordinate} \\ \hline
Possible Values & true or false \textit{(default: true)} \\ \hline
\end{tabular} 
\end{minipage}
...
\vspace{10mm}
\noindent\begin{minipage}{\textwidth}
\hypertarget{inl:config_hybrid_top_z}
\noindent\textbf{\large{config\_hybrid\_top\_z}} (real) \\ 
\begin{tabular}{|p{.3\textwidth-2\tabcolsep} |p{.7\textwidth-2\tabcolsep} |} \hline
Units & \textit{-} \\ \hline
Description & \textit{Height at which coordinate surfaces become constant height surfaces} \\ \hline
Possible Values & Positive real values \textit{(default: 30000.0)} \\ \hline
\end{tabular} 
\end{minipage}
...
\vspace{10mm}
\noindent\begin{minipage}{\textwidth}
\hypertarget{inl:config_specified_zeta_levels}
\noindent\textbf{\large{config\_specified\_zeta\_levels}} (character) \\ 
\begin{tabular}{|p{.3\textwidth-2\tabcolsep} |p{.7\textwidth-2\tabcolsep} |} \hline
Units & \textit{-} \\ \hline
Description & \textit{The name of a text file containing a list of vertical coordinate (zeta) values in increasing order at layer interfaces. (hidden by default)} \\ \hline
...
\vspace{10mm}
\noindent\begin{minipage}{\textwidth}
\hypertarget{inl:config_blend_bdy_terrain}
\noindent\textbf{\large{config\_blend\_bdy\_terrain}} (logical) \\ 
\begin{tabular}{|p{.3\textwidth-2\tabcolsep} |p{.7\textwidth-2\tabcolsep} |} \hline
Units & \textit{-} \\ \hline
Description & \textit{Whether to blend terrain along domain boundaries with first-guess terrain. Only useful for limited-area domains.} \\ \hline
Possible Values & true or false \textit{(default: false)} \\ \hline
\end{tabular} 
\end{minipage}
...
Possible Values & `constant' (last valid value), `linear' (linear extrapolation based on last two values), `lapse-rate' (0.0065 K/m from last valid value) \textit{(default: lapse-rate)} \\ \hline
\end{tabular} 
\end{minipage}
...
\begin{tabular}{|p{.3\textwidth-2\tabcolsep} |p{.7\textwidth-2\tabcolsep} |} \hline
Units & \textit{-} \\ \hline
Description & \textit{Whether to recompute subgrid-scale orography statistics directly on the native MPAS mesh (case 7 only)} \\ \hline
Possible Values & true or false \textit{(default: true)} \\ \hline
\end{tabular} 
\end{minipage}
...
\vspace{10mm}
\noindent\begin{minipage}{\textwidth}
\hypertarget{inl:config_native_gwd_gsl_static}
\noindent\textbf{\large{config\_native\_gwd\_gsl\_static}} (logical) \\ 
\begin{tabular}{|p{.3\textwidth-2\tabcolsep} |p{.7\textwidth-2\tabcolsep} |} \hline
Units & \textit{-} \\ \hline
Description & \textit{Whether to recompute subgrid-scale orography statistics for the GSL drag directly on the native MPAS mesh (case 7 only)} \\ \hline
Possible Values & true or false \textit{(default: false)} \\ \hline
\end{tabular} 
\end{minipage}
...
\end{tabular} 
\end{minipage}
\hypertarget{irec:physics}{}
\section{physics}
\small

\vspace{10mm}
\noindent\begin{minipage}{\textwidth}
\hypertarget{inl:config_tsk_seaice_threshold}
\noindent\textbf{\large{config\_tsk\_seaice\_threshold}} (real) \\ 
\begin{tabular}{|p{.3\textwidth-2\tabcolsep} |p{.7\textwidth-2\tabcolsep} |} \hline
Units & \textit{K} \\ \hline
Description & \textit{surface temperature threshold below which water points are set to seaice points (hidden by default)} \\ \hline
Possible Values & Positive real values \textit{(default: 100.)} \\ \hline
\end{tabular} 
\end{minipage}
\hypertarget{irec:io}{}
\section{io}
