...
Possible Values & 1 -- 9 \textit{(default: 7)} \\ \hline
\end{tabular} 
\end{minipage}
...
Possible Values & `USGS' or `MODIFIED\_IGBP\_MODIS\_NOAH' \textit{(default: MODIFIED\_IGBP\_MODIS\_NOAH)} \\ \hline
\end{tabular} 
\end{minipage}
...
\begin{tabular}{|p{.3\textwidth-2\tabcolsep} |p{.7\textwidth-2\tabcolsep} |} \hline
Units & \textit{-} \\ \hline
Description & \textit{The supersampling factor to be used for 30s terrain, MODIS land use, soil category, and MODIS FPAR monthly vegetation fraction (case 7 only)} \\ \hline
